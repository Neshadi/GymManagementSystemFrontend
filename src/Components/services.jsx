    ...
    <div className={classes.root} id="services">
      <Container maxWidth="md">
        ...
        <Typography variant="body1" paragraph>
          At our gym, we offer a wide range of services to help you reach your fitness goals. From personal training to group classes,nutritional guidelines have for everyone.
        </Typography>
