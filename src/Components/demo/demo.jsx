...
const BookDemo = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/demo/book", user, { headers });
  ...
  const handleUpdate1 = async (id) => {
    ...
    if (editing && id) {
      ...
      try {
        ...
        const response = await axios.put(`http://localhost:8080/demo/updateBook/${id}`, updatedDemo, { headers }); 
  ...
  const handleDelete1 = async (id) => {
    ...
    if (deleting && id) {
      try {
        const response = await axios.delete(`http://localhost:8080/demo/delete/${id}`, { headers });
  ...
  const handleDemo = async () => {
    ...
    try {
      const response = await axios.get('http://localhost:8080/demo/findBook', { headers });
